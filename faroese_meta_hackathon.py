...
dataset = load_dataset("OpenGenerativeAI/Llama3.3_Distil_Open_Faroese", split = "train")
...
if False: model.push_to_hub_merged("OpenGenerativeAI/Llama-3.2-3B-Faroese-Instruct-16bit", tokenizer, save_method = "merged_16bit", token = "")

# Merge to 4bit
if True: model.save_pretrained_merged("model4", tokenizer, save_method = "merged_4bit_forced",)
if False: model.push_to_hub_merged("OpenGenerativeAI/Llama-3.2-3B-Faroese-Instruct-4bit", tokenizer, save_method = "merged_4bit", token = "")
